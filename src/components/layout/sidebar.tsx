        ...
        <div className="flex h-full flex-col">
            ...
            <div className="border-t border-border p-3">
                <div className="rounded-md bg-muted/50 p-2.5 text-center">
                    ...
                    <p className="mt-0.5 text-[10px] text-muted-foreground">21 CFR 101.9</p>
                </div>
            </div>
        </div>
    );
...
export function Sidebar() {
    ...
    return (
        <>
                ...
                <Sheet open={open} onOpenChange={setOpen}>
                    <SheetTrigger asChild>
                        <Button
                            variant="outline"
                            size="icon"
                            className="h-8 w-8 bg-card shadow-soft border-border"
                        >
            ...
            {/* Desktop sidebar */}
            <aside className="hidden lg:block fixed left-0 top-0 z-40 h-screen w-60 bg-sidebar border-r border-border">
                <SidebarContent />
            </aside>
        </>
    );
